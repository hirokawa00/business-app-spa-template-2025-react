...
import { ArrowUpDown, ChevronDown, Search, Settings } from 'lucide-react';
...
const UserFilters = ({
  ...
  return (
    <div className="flex flex-col gap-4 border background">
        ...
        <div className="flex justify-between items-center  py-1">
          <div className="flex flex-col gap-4 background h-8">
            <div className="flex h-8 space-x-2">
              ...
              <DataTableFacetedFilter title="aaa" options={statuses} />
